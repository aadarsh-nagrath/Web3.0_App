  ...
  return (
    ...
    <div className='flex items-center justify-between border-b-[0.5px] border-[#30363d] p-4'>
        ...
        <div className='flex items-center justify-between px-2 py-1 rounded-md bg-[#0d1117] border-[0.5px] border-[#30363d] w-full md:w-auto'>
            ...
            <div className='md:px-8 px-2 text-white whitespace-nowrap overflow-hidden text-[14px] text-ellipsis'>www.CrowdScape.com</div>
        ...
        <div className='min-w-0 w-full'>
            <div className='border-b-[0.5px] border-[#30363d] text-[#7d8590]'>
                <ul className='flex px-3 pt-4'>
                    <li className='px-3 py-2 rounded-t-md bg-[#0d1117] text-gray-300'>About us</li>
                    <li className='px-3 py-2'>All campaigns</li>
                    <li className='px-3 py-2 '>Connect To Our Community</li>
                </ul>
            ...
            <div className='p-4 text-[#7d8590]'>
                <ul className='flex mb-3'>
                    <li className='pr-3 text-gray-200'>Campaign</li>
                    <li className='pr-3'>Community</li>
                    <li className='pr-3'>NFT MarketPlace</li>
                ...
                <motion.div variants={container} initial='hidden' whileInView='show' viewport={{once:false, amount:0.5}} className="overflow-hidden whitespace-nowrap font-mono text-[14px] text-[#7d8590]" data-type-row-delay="50">
                    <motion.div variants={item} className="no-wrap js-type-row row-is-visible" >
                        ...
                        <span>  </span>
                        &apos;<span className="color-fg-accent">Want to start a campaign ?</span>&apos;
                
                    </motion.div>
                    <motion.div variants={item} className="no-wrap js-type-row row-is-visible">
                        [<span className="color-fg-subtle">Step-1</span>]
                        <span> First of all, link your METAMASK WALLET. </span>
                        <span className="color-fg-accent"></span>
                        <span className="color-fg-done"></span>
                    </motion.div>
                    <motion.div variants={item} className="no-wrap js-type-row row-is-visible">
                        [<span className="color-fg-subtle">Step-2</span>]
                        <span> Select a Campaign name and title. </span>
                    </motion.div>
                    <motion.div variants={item} className="no-wrap js-type-row row-is-visible" >
                        [<span className="color-fg-subtle">Step-3</span>]
                        <span> Select a goal. (Set a amount to be raised) </span>
                        
                        
                    </motion.div>
                    <motion.div variants={item} className="no-wrap js-type-row row-is-visible">
                        [<span className="color-fg-subtle">Step-4</span>]
                        <span> Add a description to it. </span>
                       
                    </motion.div>
                    <motion.div variants={item} className="no-wrap js-type-row row-is-visible">
                        [<span className="color-fg-subtle">Step-5</span>]
                        <span> Add a suitable image for your campaign.  </span>
                        
                    </motion.div>
                    <motion.div variants={item} className="no-wrap js-type-row row-is-visible" >
                        <span className="color-fg-subtle"></span>
                        <span>  </span>
                        <span className="color-fg-accent">You are all set to go !!!</span>
                    ...
                    <motion.div variants={item} className="no-wrap js-type-row row-is-visible" >
                        ...
                        <span>  </span>
                        {/* <span className="color-fg-accent"></span>
                        Wait for our community to show their magic. */}
                        <span className="color-fg-done">Wait for our community to show their magic.</span>
                    </motion.div>
