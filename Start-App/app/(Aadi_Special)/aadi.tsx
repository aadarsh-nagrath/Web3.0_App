      ...
      <div>
        <div className='overflow-hidden'>
          <div className='relative'>
            <Image className='absolute top-0 transition ease-in duration-200 max-xl:right-[-1050px] xl:right-[-970px] -z-30 image' width='4377' height='4000' src="https://github.githubassets.com/images/modules/site/home-campaign/hero-bg.webp" alt="space-img" />
          </div>
