...
const Hero = (props: Props) => {
  ...
  return (
    <div className='relative max-w-[1280px] lg:pt-32 md:px-10 mx-auto pt-16'>
        <Image className='absolute hero-drone top-28 w-1/4 h-auto right-0 xl:right-0' width="500" height="326" src="https://github.githubassets.com/images/modules/site/home-campaign/hero-drone.webp" alt="" />
        <div className='flex'>
            <div className='relative '>
                <Image aria-hidden="true" className='' src="https://github.githubassets.com/images/modules/site/home-campaign/lines-hero.svg" width="437" height="637" alt="" />
            ...
            <div className= ' absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
                ...
                <p className="text-[16px] leading-[24px] text-[#7d8590]">Trusted by the Chandigarh University</p>
                </div>
            </div>
        </div>
    </div>
