    ...
    <div className=" 1300 1300:w-[1250px] h-full  flex flex-row items-center justify-between z-[-10] mt-[80px] 500:mt-0  ">
      ...
      >
        ...
        <p className=" animate-slideleftT3 text-[16px] 400:text-[19px] text-slate-400 mb-[20px]  ">
          ...
          <a className="Home_a ">Aadi</a>,
          <a className="Home_a">Aadi</a>,
          <a className="Home_a">Aadi</a>, The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero De Finibus Bonorum et Malorum for use in a type specimen book.
        </p>
        <a
          href="#Section_4"
          id="button-primary"
