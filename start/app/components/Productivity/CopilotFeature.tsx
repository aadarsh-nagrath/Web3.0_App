...
const CopilotFeature = (props: Props) => {
  ...
  return (
    ...
    <div className='md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between '>
        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>Crowd Scape</span> focus solely on raising funds, we go a step further. We curate campaigns that have the potential to create real, meaningful impact. Our commitment is to projects that bring about positive change, whether it's in technology, arts, social good, or beyond.</p>
        <div>
                ...
                <div className={`p-4 relative bg-[#0d1117] ${showPy ? "" : "hidden"}`}>
                    <div className='flex'>
                        ...
                        <div key={count} className='flex-1 overflow-x-auto text-white rounded-b-md '>
                            <pre className=""><span className="code-editor-line-mktg"><span className="pl-k">Your Dream, Our Community, Endless Possibilities  </span> <span className="pl-s1"></span><span className="pl-s1"></span> <span className="pl-k"></span> <span className="pl-s1"></span></span></pre>
                            <pre className=""><span className="code-editor-line-mktg"></span></pre>
                            <pre className=""><motion.span variants={container} initial='hidden' whileInView='show' className="code-editor-line-mktg"><motion.span variants={item} className="pl-k js-type-letters"></motion.span><motion.span variants={item} className="js-type-letters"> </motion.span><motion.span variants={item} className="pl-en js-type-letters">What makes us better than exisiting platforms - </motion.span><motion.span variants={item} className="js-type-letters"></motion.span><motion.span variants={item} className="pl-s1 js-type-letters"></motion.span><motion.span variants={item} className="js-type-letters"> </motion.span><motion.span variants={item} className="pl-s1 js-type-letters"></motion.span><motion.span variants={item} className="js-type-letters"></motion.span></motion.span></pre>
                            <motion.div initial={{opacity:0, y:40}} whileInView={{opacity:1, y:0}} transition={{delay:1, type:'just'}}>
                            <pre className=" bg-[#388bfd1a]"><span>    <span className="pl-s1">• 0% Platform Fees</span><span className="pl-en"></span><span className="pl-s1"></span> <span className="pl-s1"></span> <span className="pl-s1"></span><span className="pl-c1"></span><span className="pl-c1"></span></span></pre>
                            <pre className=" bg-[#388bfd1a]"><span>    <span className="pl-s1">• Impact-Driven Crowding
                            </span><span className="pl-en"></span><span className="pl-s"></span></span></pre>
                            <pre className=" bg-[#388bfd1a]"><span>    <span className="pl-s1">• Unparalleled Support
</span><span className="pl-en"></span><span className="pl-s"></span></span></pre>
                            <pre className=" bg-[#388bfd1a]"><span>    <span className="pl-s1">• Innovative tools and Resources
</span><span className="pl-en"></span><span className="pl-s"></span></span></pre>
                            <pre className=" bg-[#388bfd1a]"><span>    <span className="pl-s1">• Transparent and Secure</span><span className="pl-en"></span></span></pre>
