      ...
      <div className="flex md:pl-10 space-x-3 md:space-x-10">
        ...
        <div className="md:w-10/12 mb-24">
          ...
          <motion.h3
            ...
            viewport={{ once: false }}
            className="text-[24px] md:text-[40px] max-md:leading-8 max-lg:leading-10 lg:text-5xl mb-7 font-medium text-white js-build-in-item build-in-slideX-left build-in-animate"
            style={{ transitionDelay: '300ms' }}
          >
            Choose us as your crowdfunding platform for an{' '}
            <span className="text-[#7ee787]">engaged </span> and{' '}
            <span className="text-[#7ee787]">supportive </span> community eager
            to back your dreams . With our{' '}
            <span className="text-[#7ee787]">
              user-friendly interface, expert guidance
            </span>{' '}
            and <span className="text-[#7ee787]">0% platform fees </span>
        ...
        <div className="flex justify-between md:space-x-10 max-md:flex-col">
          <HoverCard backgroundColor="#7ee787" direction="flex-col" left="0">
            <div className="md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
              <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
                <span className="text-white font-semibold">Crowd Scape</span> is
                website built on blockchain so it completely secure and
                transparent.
              </p>
              <div>
                <a
          ...
          >
            <div className="md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
              <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
                <span className="text-white font-semibold">Crowd Scape</span> is
                provides us with flexible funding options and has a user
                friendly interface.
              </p>
              <div>
                <a
