    ...
    <div className='max-w-[1280px] mx-auto relative z-[2]'>
      <div className='flex my-8 md:my-16 sm:my-12 relative md:items-center text-center flex-col'>
          <div className='py-3 mb-2 flex flex-col justify-center items-center'>
            <h2 className='px-4 mb-4 md:w-9/12 mx-auto lg:text-5xl md:text-4xl text-3xl font-bold text-white'>The place for anyone from anywhere to raise funds for their ideas, innovations and needs.</h2>
            <p className="mb-4 md:text-xl text-[16px] text-[#7d8590] px-4 mx-auto md:w-7/12">Whether you’re scaling your startup or want to fund your ideas, CrowdScape is your home. Join the platform to help build the innovations that empower humanity. Let’s&nbsp;build from&nbsp;here.</p>
